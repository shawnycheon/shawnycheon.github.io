function rating_types = call_ratingtypes_heat
%call_ratingtypes
...
if ismember(runtype, {'REST2', 'TEST2', 'HEAT1', 'MUSIC2', 'HEAT2', 'HEAT3', 'HEAT4'})
    switch runtype
        case 'REST2' % to block the error
            data.music_order = ts.run_music_order(4,:);
        case 'TEST2'% to block the error
            data.music_order = ts.run_music_order(4,:);
        case 'HEAT1' % to block the error
            data.music_order = ts.run_music_order(4,:);
        case 'MUSIC2'
...
rating_types.postallstims = {'REST2', 'TEST2', 'MUSIC2', 'HEAT1', 'HEAT2', 'HEAT3', 'HEAT4'};
